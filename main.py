...
from database_connect import search_all_matching, search_word, get_all_words
...
class Application(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        label = tk.Label(credit_frame, bg=theme_color, fg='#b5e6e0', text='Adidas Tri Poloski',
...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        title_label = tk.Label(mainlabel_frame, text="An English Dictionary", font=font,
                               bg=theme_color,
                               fg='#b5e6e0')
        title_label.pack()
